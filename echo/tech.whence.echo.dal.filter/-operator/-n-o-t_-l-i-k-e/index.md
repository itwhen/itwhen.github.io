...
title: NOT_LIKE -
---
//[echo](../../../index.md)/[tech.whence.echo.dal.filter](../../index.md)/[Operator](../index.md)/[NOT_LIKE](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [title](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/title/#/PointingToDeclaration/)|  [jvm] <br><br>String 描述<br><br>open override val [title](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/title/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [value](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/value/#/PointingToDeclaration/)|  [jvm] <br><br>String 缩略词<br><br>open override val [value](index.md#tech.whence.echo.dal.filter/Operator.NOT_LIKE/value/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
