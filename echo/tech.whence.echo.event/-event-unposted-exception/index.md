...
---
//[echo](../../index.md)/[tech.whence.echo.event](../index.md)/[EventUnpostedException](index.md)
...
class [EventUnpostedException](index.md)(**event**: [Event](../-event/index.md), **cause**: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?) : [RuntimeException](https://docs.oracle.com/javase/8/docs/api/java/lang/RuntimeException.html)   
...
|  Name|  Summary| 
|---|---|
| [EventUnpostedException](-event-unposted-exception.md)|  [jvm] <br><br><br><br>fun [EventUnpostedException](-event-unposted-exception.md)(event: [Event](../-event/index.md), cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?)   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.event/EventUnpostedException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.event/EventUnpostedException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [event](index.md#tech.whence.echo.event/EventUnpostedException/event/#/PointingToDeclaration/)|  [jvm] <br><br>Event 指定事件<br><br>val [event](index.md#tech.whence.echo.event/EventUnpostedException/event/#/PointingToDeclaration/): [Event](../-event/index.md)   <br>
| [message](index.md#tech.whence.echo.event/EventUnpostedException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.event/EventUnpostedException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
