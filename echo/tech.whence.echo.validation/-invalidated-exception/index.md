...
---
//[echo](../../index.md)/[tech.whence.echo.validation](../index.md)/[InvalidatedException](index.md)
...
class [InvalidatedException](index.md)(**errors**: [Errors](../-errors/index.md)) : [RuntimeException](https://docs.oracle.com/javase/8/docs/api/java/lang/RuntimeException.html)   
...
|  Name|  Summary| 
|---|---|
| [InvalidatedException](-invalidated-exception.md)|  [jvm] <br><br><br><br>fun [InvalidatedException](-invalidated-exception.md)(errors: [Errors](../-errors/index.md))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.validation/InvalidatedException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.validation/InvalidatedException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [errors](index.md#tech.whence.echo.validation/InvalidatedException/errors/#/PointingToDeclaration/)|  [jvm] <br><br>Errors 校验错误<br><br>val [errors](index.md#tech.whence.echo.validation/InvalidatedException/errors/#/PointingToDeclaration/): [Errors](../-errors/index.md)   <br>
| [message](index.md#tech.whence.echo.validation/InvalidatedException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.validation/InvalidatedException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
