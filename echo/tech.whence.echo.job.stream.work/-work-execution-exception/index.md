...
---
//[echo](../../index.md)/[tech.whence.echo.job.stream.work](../index.md)/[WorkExecutionException](index.md)
...
|  Name|  Summary| 
|---|---|
| [WorkExecutionException](-work-execution-exception.md)|  [jvm] <br><br><br><br>fun [WorkExecutionException](-work-execution-exception.md)(stage: [Workstage](../../tech.whence.echo.job.stream.workstage/-workstage/index.md), worker: [Thread](https://docs.oracle.com/javase/8/docs/api/java/lang/Thread.html)?, throwable: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?)   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
| [stage](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/stage/#/PointingToDeclaration/)|  [jvm] <br><br>Workstage 工作阶段<br><br>val [stage](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/stage/#/PointingToDeclaration/): [Workstage](../../tech.whence.echo.job.stream.workstage/-workstage/index.md)   <br>
| [worker](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/worker/#/PointingToDeclaration/)|  [jvm] <br><br>Thread? 工作线程<br><br>val [worker](index.md#tech.whence.echo.job.stream.work/WorkExecutionException/worker/#/PointingToDeclaration/): [Thread](https://docs.oracle.com/javase/8/docs/api/java/lang/Thread.html)?   <br>
