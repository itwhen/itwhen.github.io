...
---
//[echo](../../index.md)/[tech.whence.echo.job.manager.state](../index.md)/[StateInvalidException](index.md)
...
class [StateInvalidException](index.md)(**sources**: [Set](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-set/index.html)<[State](../-state/index.md)>, **target**: [State](../-state/index.md), **current**: [State](../-state/index.md)) : [RuntimeException](https://docs.oracle.com/javase/8/docs/api/java/lang/RuntimeException.html)   
...
|  Name|  Summary| 
|---|---|
| [StateInvalidException](-state-invalid-exception.md)|  [jvm] <br><br><br><br>fun [StateInvalidException](-state-invalid-exception.md)(sources: [Set](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-set/index.html)<[State](../-state/index.md)>, target: [State](../-state/index.md), current: [State](../-state/index.md))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.job.manager.state/StateInvalidException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.job.manager.state/StateInvalidException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [current](index.md#tech.whence.echo.job.manager.state/StateInvalidException/current/#/PointingToDeclaration/)|  [jvm] <br><br>State 当前状态<br><br>val [current](index.md#tech.whence.echo.job.manager.state/StateInvalidException/current/#/PointingToDeclaration/): [State](../-state/index.md)   <br>
| [message](index.md#tech.whence.echo.job.manager.state/StateInvalidException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.job.manager.state/StateInvalidException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
| [sources](index.md#tech.whence.echo.job.manager.state/StateInvalidException/sources/#/PointingToDeclaration/)|  [jvm] <br><br>Set<State> 来源状态<br><br>val [sources](index.md#tech.whence.echo.job.manager.state/StateInvalidException/sources/#/PointingToDeclaration/): [Set](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-set/index.html)<[State](../-state/index.md)>   <br>
| [target](index.md#tech.whence.echo.job.manager.state/StateInvalidException/target/#/PointingToDeclaration/)|  [jvm] <br><br>State 目标状态<br><br>val [target](index.md#tech.whence.echo.job.manager.state/StateInvalidException/target/#/PointingToDeclaration/): [State](../-state/index.md)   <br>
