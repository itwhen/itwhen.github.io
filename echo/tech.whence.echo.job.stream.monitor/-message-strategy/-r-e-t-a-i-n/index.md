...
title: RETAIN -
---
//[echo](../../../index.md)/[tech.whence.echo.job.stream.monitor](../../index.md)/[MessageStrategy](../index.md)/[RETAIN](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#tech.whence.echo.job.stream.monitor/MessageStrategy.RETAIN/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#tech.whence.echo.job.stream.monitor/MessageStrategy.RETAIN/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#tech.whence.echo.job.stream.monitor/MessageStrategy.RETAIN/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#tech.whence.echo.job.stream.monitor/MessageStrategy.RETAIN/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
