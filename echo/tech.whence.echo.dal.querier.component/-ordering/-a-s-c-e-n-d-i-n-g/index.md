...
title: ASCENDING -
---
//[echo](../../../index.md)/[tech.whence.echo.dal.querier.component](../../index.md)/[Ordering](../index.md)/[ASCENDING](index.md)
...
|  Name|  Summary| 
|---|---|
| [name](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/name/#/PointingToDeclaration/)|  [jvm] override val [name](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/ordinal/#/PointingToDeclaration/)|  [jvm] override val [ordinal](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [title](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/title/#/PointingToDeclaration/)|  [jvm] <br><br>String 描述<br><br>open override val [title](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/title/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [value](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/value/#/PointingToDeclaration/)|  [jvm] <br><br>V 值<br><br>open override val [value](index.md#tech.whence.echo.dal.querier.component/Ordering.ASCENDING/value/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
