...
---
//[echo](../../index.md)/[tech.whence.echo.rpc.exception](../index.md)/[MissingException](index.md)
...
class [MissingException](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?) : [ResponseException](../-response-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [MissingException](-missing-exception.md)|  [jvm] <br><br><br><br>fun [MissingException](-missing-exception.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?)   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.rpc.exception/MissingException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.rpc.exception/MissingException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [failureCode](index.md#tech.whence.echo.rpc.exception/MissingException/failureCode/#/PointingToDeclaration/)|  [jvm] override val [failureCode](index.md#tech.whence.echo.rpc.exception/MissingException/failureCode/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [failureType](index.md#tech.whence.echo.rpc.exception/MissingException/failureType/#/PointingToDeclaration/)|  [jvm] override val [failureType](index.md#tech.whence.echo.rpc.exception/MissingException/failureType/#/PointingToDeclaration/): ReplyFailure   <br>
| [message](index.md#tech.whence.echo.rpc.exception/MissingException/message/#/PointingToDeclaration/)|  [jvm] <br><br>String?<br><br>open override val [message](index.md#tech.whence.echo.rpc.exception/MissingException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
