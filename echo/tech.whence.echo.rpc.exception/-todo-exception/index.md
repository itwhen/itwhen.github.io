...
title: TodoException -
---
//[echo](../../index.md)/[tech.whence.echo.rpc.exception](../index.md)/[TodoException](index.md)
...
class [TodoException](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?) : [ResponseException](../-response-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [TodoException](-todo-exception.md)|  [jvm] <br><br><br><br>fun [TodoException](-todo-exception.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?)   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.rpc.exception/TodoException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.rpc.exception/TodoException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [failureCode](index.md#tech.whence.echo.rpc.exception/TodoException/failureCode/#/PointingToDeclaration/)|  [jvm] override val [failureCode](index.md#tech.whence.echo.rpc.exception/TodoException/failureCode/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [failureType](index.md#tech.whence.echo.rpc.exception/TodoException/failureType/#/PointingToDeclaration/)|  [jvm] override val [failureType](index.md#tech.whence.echo.rpc.exception/TodoException/failureType/#/PointingToDeclaration/): ReplyFailure   <br>
| [message](index.md#tech.whence.echo.rpc.exception/TodoException/message/#/PointingToDeclaration/)|  [jvm] <br><br>String?<br><br>open override val [message](index.md#tech.whence.echo.rpc.exception/TodoException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
