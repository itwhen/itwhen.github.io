...
---
//[echo](../../index.md)/[tech.whence.echo.dal.schema](../index.md)/[UndetectableException](index.md)
...
class [UndetectableException](index.md) : [DataAccessException](../../tech.whence.echo.dal/-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [UndetectableException](-undetectable-exception.md)|  [jvm] fun [UndetectableException](-undetectable-exception.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
| [UndetectableException](-undetectable-exception.md)|  [jvm] fun [UndetectableException](-undetectable-exception.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal.schema/UndetectableException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.dal.schema/UndetectableException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.dal.schema/UndetectableException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.dal.schema/UndetectableException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
