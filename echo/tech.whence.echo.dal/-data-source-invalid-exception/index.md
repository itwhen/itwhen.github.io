...
---
//[echo](../../index.md)/[tech.whence.echo.dal](../index.md)/[DataSourceInvalidException](index.md)
...
class [DataSourceInvalidException](index.md)(**cause**: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)) : [DataAccessException](../-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [DataSourceInvalidException](-data-source-invalid-exception.md)|  [jvm] <br><br><br><br>fun [DataSourceInvalidException](-data-source-invalid-exception.md)(cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal/DataSourceInvalidException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.dal/DataSourceInvalidException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.dal/DataSourceInvalidException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.dal/DataSourceInvalidException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
