...
title: OneTimeRetry -
---
//[echo](../../index.md)/[tech.whence.echo.retry](../index.md)/[OneTimeRetry](index.md)
...
class [OneTimeRetry](index.md)(**duration**: [Duration](https://docs.oracle.com/javase/8/docs/api/java/time/Duration.html)) : [NTimesRetry](../-n-times-retry/index.md)   
...
|  Name|  Summary| 
|---|---|
| [OneTimeRetry](-one-time-retry.md)|  [jvm] <br><br><br><br>fun [OneTimeRetry](-one-time-retry.md)(duration: [Duration](https://docs.oracle.com/javase/8/docs/api/java/time/Duration.html))   <br>
...
| [next](../-n-times-retry/next.md)| [jvm]  <br>Brief description  <br><br><br>取下一个持续时间<br><br>  <br>Content  <br>open override fun [next](../-n-times-retry/next.md)(retrying: [Retrying](../-retrying/index.md)): [Duration](https://docs.oracle.com/javase/8/docs/api/java/time/Duration.html)  <br><br><br>
