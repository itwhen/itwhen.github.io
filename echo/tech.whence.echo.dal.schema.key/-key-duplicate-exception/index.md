...
---
//[echo](../../index.md)/[tech.whence.echo.dal.schema.key](../index.md)/[KeyDuplicateException](index.md)
...
class [KeyDuplicateException](index.md)(**key**: [Key](../-key/index.md)?, **message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?, **cause**: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?) : [DataAccessException](../../tech.whence.echo.dal/-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [KeyDuplicateException](-key-duplicate-exception.md)|  [jvm] <br><br><br><br>fun [KeyDuplicateException](-key-duplicate-exception.md)(key: [Key](../-key/index.md)?, message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?, cause: [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?)   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal.schema.key/KeyDuplicateException/cause/#/PointingToDeclaration/)|  [jvm] <br><br>Throwable?<br><br>open override val [cause](index.md#tech.whence.echo.dal.schema.key/KeyDuplicateException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [key](index.md#tech.whence.echo.dal.schema.key/KeyDuplicateException/key/#/PointingToDeclaration/)|  [jvm] <br><br>Key?<br><br>val [key](index.md#tech.whence.echo.dal.schema.key/KeyDuplicateException/key/#/PointingToDeclaration/): [Key](../-key/index.md)?   <br>
| [message](index.md#tech.whence.echo.dal.schema.key/KeyDuplicateException/message/#/PointingToDeclaration/)|  [jvm] <br><br>String?<br><br>open override val [message](index.md#tech.whence.echo.dal.schema.key/KeyDuplicateException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
