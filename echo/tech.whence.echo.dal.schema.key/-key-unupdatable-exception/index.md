...
---
//[echo](../../index.md)/[tech.whence.echo.dal.schema.key](../index.md)/[KeyUnupdatableException](index.md)
...
class [KeyUnupdatableException](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [DataAccessException](../../tech.whence.echo.dal/-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [KeyUnupdatableException](-key-unupdatable-exception.md)|  [jvm] <br><br><br><br>fun [KeyUnupdatableException](-key-unupdatable-exception.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal.schema.key/KeyUnupdatableException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.dal.schema.key/KeyUnupdatableException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.dal.schema.key/KeyUnupdatableException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.dal.schema.key/KeyUnupdatableException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
| [name](index.md#tech.whence.echo.dal.schema.key/KeyUnupdatableException/name/#/PointingToDeclaration/)|  [jvm] <br><br>String 字段名<br><br>val [name](index.md#tech.whence.echo.dal.schema.key/KeyUnupdatableException/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
