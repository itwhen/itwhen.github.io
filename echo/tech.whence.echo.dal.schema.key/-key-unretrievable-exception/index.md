...
---
//[echo](../../index.md)/[tech.whence.echo.dal.schema.key](../index.md)/[KeyUnretrievableException](index.md)
...
class [KeyUnretrievableException](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [DataAccessException](../../tech.whence.echo.dal/-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [KeyUnretrievableException](-key-unretrievable-exception.md)|  [jvm] <br><br><br><br>fun [KeyUnretrievableException](-key-unretrievable-exception.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal.schema.key/KeyUnretrievableException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.dal.schema.key/KeyUnretrievableException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.dal.schema.key/KeyUnretrievableException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.dal.schema.key/KeyUnretrievableException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
| [name](index.md#tech.whence.echo.dal.schema.key/KeyUnretrievableException/name/#/PointingToDeclaration/)|  [jvm] <br><br>String 字段名<br><br>val [name](index.md#tech.whence.echo.dal.schema.key/KeyUnretrievableException/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
