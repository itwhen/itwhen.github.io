...
---
//[echo](../../index.md)/[tech.whence.echo.dal.schema.key](../index.md)/[KeyUnassignedException](index.md)
...
class [KeyUnassignedException](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [DataAccessException](../../tech.whence.echo.dal/-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [KeyUnassignedException](-key-unassigned-exception.md)|  [jvm] <br><br><br><br>fun [KeyUnassignedException](-key-unassigned-exception.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal.schema.key/KeyUnassignedException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.dal.schema.key/KeyUnassignedException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.dal.schema.key/KeyUnassignedException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.dal.schema.key/KeyUnassignedException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
| [name](index.md#tech.whence.echo.dal.schema.key/KeyUnassignedException/name/#/PointingToDeclaration/)|  [jvm] <br><br>String 字段名<br><br>val [name](index.md#tech.whence.echo.dal.schema.key/KeyUnassignedException/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
