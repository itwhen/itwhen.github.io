...
---
//[echo](../../index.md)/[tech.whence.echo.dal.schema.key](../index.md)/[KeyIllformedException](index.md)
...
class [KeyIllformedException](index.md)(**name**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [DataAccessException](../../tech.whence.echo.dal/-data-access-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [KeyIllformedException](-key-illformed-exception.md)|  [jvm] <br><br><br><br>fun [KeyIllformedException](-key-illformed-exception.md)(name: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html))   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.dal.schema.key/KeyIllformedException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.dal.schema.key/KeyIllformedException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.dal.schema.key/KeyIllformedException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.dal.schema.key/KeyIllformedException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
| [name](index.md#tech.whence.echo.dal.schema.key/KeyIllformedException/name/#/PointingToDeclaration/)|  [jvm] <br><br>String 指定字段<br><br>val [name](index.md#tech.whence.echo.dal.schema.key/KeyIllformedException/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
