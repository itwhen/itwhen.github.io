...
---
//[echo](../../index.md)/[tech.whence.echo.job.stream.collector](../index.md)/[AbstractBlockingCollector](index.md)
...
abstract class [AbstractBlockingCollector](index.md)<[T](index.md) : [Message](../../tech.whence.echo.job.stream.message/-message/index.md)>(**queue**: [BlockingQueue](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/BlockingQueue.html)<[T](index.md)>, **strictly**: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)) : [AbstractCollector](../-abstract-collector/index.md)<[BlockingQueue](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/BlockingQueue.html)<[T](index.md)>, [T](index.md)>    
...
|  Name|  Summary| 
|---|---|
| [AbstractBlockingCollector](-abstract-blocking-collector.md)|  [jvm] <br><br><br><br>fun <[T](index.md) : [Message](../../tech.whence.echo.job.stream.message/-message/index.md)> [AbstractBlockingCollector](-abstract-blocking-collector.md)(queue: [BlockingQueue](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/BlockingQueue.html)<[T](index.md)>, strictly: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html))   <br>
