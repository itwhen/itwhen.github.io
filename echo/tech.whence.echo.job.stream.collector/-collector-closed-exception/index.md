...
---
//[echo](../../index.md)/[tech.whence.echo.job.stream.collector](../index.md)/[CollectorClosedException](index.md)
...
class [CollectorClosedException](index.md) : [CollectorInterruptedException](../-collector-interrupted-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [CollectorClosedException](-collector-closed-exception.md)|  [jvm] fun [CollectorClosedException](-collector-closed-exception.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#tech.whence.echo.job.stream.collector/CollectorClosedException/cause/#/PointingToDeclaration/)|  [jvm] open override val [cause](index.md#tech.whence.echo.job.stream.collector/CollectorClosedException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#tech.whence.echo.job.stream.collector/CollectorClosedException/message/#/PointingToDeclaration/)|  [jvm] open override val [message](index.md#tech.whence.echo.job.stream.collector/CollectorClosedException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
