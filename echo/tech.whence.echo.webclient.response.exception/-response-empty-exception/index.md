...
---
//[echo](../../index.md)/[tech.whence.echo.webclient.response.exception](../index.md)/[ResponseEmptyException](index.md)
...
class [ResponseEmptyException](index.md) : [ResponseException](../-response-exception/index.md)   
...
|  Name|  Summary| 
|---|---|
| [ResponseEmptyException](-response-empty-exception.md)|  [jvm] fun [ResponseEmptyException](-response-empty-exception.md)()   <br>
