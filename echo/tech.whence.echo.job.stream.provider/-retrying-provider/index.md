---
title: RetryingProvider -
---
//[echo](../../index.md)/[tech.whence.echo.job.stream.provider](../index.md)/[RetryingProvider](index.md)
...
重试任务提供者 默认重试=退火间隔30秒重试3次

class [RetryingProvider](index.md)(**vertx**: Vertx, **retry**: [Retry](../../tech.whence.echo.retry/-retry/index.md)?) : [AbstractProvider](../-abstract-provider/index.md)<[RetryingProvider.InnerTask](-inner-task/index.md)> , [Provider](../-provider/index.md)   
...
|  Name|  Summary| 
|---|---|
| [RetryingProvider](-retrying-provider.md)|  [jvm] <br><br><br><br>fun [RetryingProvider](-retrying-provider.md)(vertx: Vertx, retry: [Retry](../../tech.whence.echo.retry/-retry/index.md)?)   <br>
...
|  Name|  Summary| 
|---|---|
| [append](index.md#tech.whence.echo.job.stream.provider/AbstractProvider/append/#tech.whence.echo.job.stream.provider.RetryingProvider.InnerTask/PointingToDeclaration/)| [jvm]  <br>Brief description  <br><br><br>附加新消息<br><br>  <br>Content  <br>override fun [append](index.md#tech.whence.echo.job.stream.provider/AbstractProvider/append/#tech.whence.echo.job.stream.provider.RetryingProvider.InnerTask/PointingToDeclaration/)(message: [RetryingProvider.InnerTask](-inner-task/index.md))  <br><br><br>[jvm]  <br>Brief description  <br><br><br>新增任务<br><br>  <br>Content  <br>fun [append](append.md)(task: [Task](../../tech.whence.echo.job.stream.task/-task/index.md), retry: [Retry](../../tech.whence.echo.retry/-retry/index.md)?)  <br><br><br>
